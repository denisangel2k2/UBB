...
import com.socialnetwork.app.repository.*;
...
public class Main extends Application {
    ...
    private static AbstractRepo<Message> messageRepo =new MessageRepo(url,username,password, (UserRepo) userRepository);
    private static Service service=new AppService((UserRepo) userRepository, (FriendshipRepo) friendshipRepo,(MessageRepo) messageRepo, userValidator,friendshipValidator);
